...
func TestProxyTargetConfigRejectsUncompiledTargets(t *testing.T) {
	...
	tests := []ProxyTargetConfig{
		{Kind: "nginx", Binary: "/usr/sbin/apachectl", Unit: "nginx.service", SystemctlBinary: "/usr/bin/systemctl", ConfigRoots: []string{"/etc/nginx"}},
		{Kind: "nginx", Binary: "/tmp/nginx", Unit: "nginx.service", SystemctlBinary: "/usr/bin/systemctl", ConfigRoots: []string{"/etc/nginx"}},
		{Kind: "nginx", Binary: "/usr/sbin/nginx", Unit: "postgresql.service", SystemctlBinary: "/usr/bin/systemctl", ConfigRoots: []string{"/etc/nginx"}},
		{Kind: "nginx", Binary: "/usr/sbin/nginx", Unit: "nginx.service", SystemctlBinary: "/tmp/systemctl", ConfigRoots: []string{"/etc/nginx"}},
		{Kind: "nginx", Binary: "/usr/sbin/nginx", Unit: "nginx.service", SystemctlBinary: "/usr/bin/systemctl", ConfigRoots: []string{"/etc"}},
	}
